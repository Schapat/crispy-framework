...
This is a thinking template, not a scaffold or installer payload. Do not copy
this candidate tree verbatim into a target project. Create real folders only
when a story enters implementation and the selected stack needs them.
